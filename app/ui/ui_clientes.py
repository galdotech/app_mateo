...
class Ui_ClientesDialog(object):
    def setupUi(self, ClientesDialog):
        ...
        self.labelNombre.setBuddy(self.lineEditNombre)
        self.labelTelefono.setBuddy(self.lineEditTelefono)
        self.labelEmail.setBuddy(self.lineEditEmail)
        self.labelDireccion.setBuddy(self.lineEditDireccion)
        self.labelNif.setBuddy(self.lineEditNif)
        self.labelNotas.setBuddy(self.plainTextEditNotas)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.lineEditNombre, self.lineEditTelefono)
        QWidget.setTabOrder(self.lineEditTelefono, self.lineEditEmail)
        QWidget.setTabOrder(self.lineEditEmail, self.lineEditDireccion)
        QWidget.setTabOrder(self.lineEditDireccion, self.lineEditNif)
        QWidget.setTabOrder(self.lineEditNif, self.plainTextEditNotas)
        QWidget.setTabOrder(self.plainTextEditNotas, self.btnAgregar)
        QWidget.setTabOrder(self.btnAgregar, self.btnGuardar)
        QWidget.setTabOrder(self.btnGuardar, self.tableClientes)
        QWidget.setTabOrder(self.tableClientes, self.btnEliminar)
    ...
    def retranslateUi(self, ClientesDialog):
        ...
        self.lineEditNombre.setPlaceholderText(QCoreApplication.translate("ClientesDialog", u"Nombre del cliente...", None))
#if QT_CONFIG(accessibility)
        self.lineEditNombre.setAccessibleName(QCoreApplication.translate("ClientesDialog", u"nombre", None))
#endif // QT_CONFIG(accessibility)
        self.labelTelefono.setText(QCoreApplication.translate("ClientesDialog", u"&Tel\u00e9fono", None))
        self.lineEditTelefono.setPlaceholderText(QCoreApplication.translate("ClientesDialog", u"555123456", None))
#if QT_CONFIG(accessibility)
        self.lineEditTelefono.setAccessibleName(QCoreApplication.translate("ClientesDialog", u"telefono", None))
#endif // QT_CONFIG(accessibility)
        self.labelEmail.setText(QCoreApplication.translate("ClientesDialog", u"&Email", None))
        self.lineEditEmail.setPlaceholderText(QCoreApplication.translate("ClientesDialog", u"correo@ejemplo.com", None))
#if QT_CONFIG(accessibility)
        self.lineEditEmail.setAccessibleName(QCoreApplication.translate("ClientesDialog", u"email", None))
#endif // QT_CONFIG(accessibility)
        self.labelDireccion.setText(QCoreApplication.translate("ClientesDialog", u"&Direcci\u00f3n", None))
        self.lineEditDireccion.setPlaceholderText(QCoreApplication.translate("ClientesDialog", u"Calle...", None))
        self.labelNif.setText(QCoreApplication.translate("ClientesDialog", u"&NIF", None))
        self.lineEditNif.setPlaceholderText(QCoreApplication.translate("ClientesDialog", u"00000000X", None))
        self.labelNotas.setText(QCoreApplication.translate("ClientesDialog", u"&Notas", None))
        self.plainTextEditNotas.setPlaceholderText(QCoreApplication.translate("ClientesDialog", u"Notas adicionales...", None))
