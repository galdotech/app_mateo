...
class Ui_ReparacionesDialog(object):
    def setupUi(self, ReparacionesDialog):
        ...
        self.labelCliente.setBuddy(self.lineEditCliente)
        self.labelMarca.setBuddy(self.lineEditMarca)
        self.labelModelo.setBuddy(self.lineEditModelo)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.lineEditCliente, self.lineEditMarca)
        QWidget.setTabOrder(self.lineEditMarca, self.lineEditModelo)
        QWidget.setTabOrder(self.lineEditModelo, self.plainTextDiagnostico)
        QWidget.setTabOrder(self.plainTextDiagnostico, self.plainTextAcciones)
        QWidget.setTabOrder(self.plainTextAcciones, self.plainTextPiezas)
        QWidget.setTabOrder(self.plainTextPiezas, self.comboEstado)
        QWidget.setTabOrder(self.comboEstado, self.comboPrioridad)
        QWidget.setTabOrder(self.comboPrioridad, self.doubleSpinBoxManoObra)
        QWidget.setTabOrder(self.doubleSpinBoxManoObra, self.doubleSpinBoxCostoPiezas)
        QWidget.setTabOrder(self.doubleSpinBoxCostoPiezas, self.doubleSpinBoxDeposito)
        QWidget.setTabOrder(self.doubleSpinBoxDeposito, self.doubleSpinBoxTotal)
        QWidget.setTabOrder(self.doubleSpinBoxTotal, self.doubleSpinBoxSaldo)
        QWidget.setTabOrder(self.doubleSpinBoxSaldo, self.lineEditTecnico)
        QWidget.setTabOrder(self.lineEditTecnico, self.spinBoxGarantia)
        QWidget.setTabOrder(self.spinBoxGarantia, self.lineEditPassBloqueo)
        QWidget.setTabOrder(self.lineEditPassBloqueo, self.checkBoxRespaldo)
        QWidget.setTabOrder(self.checkBoxRespaldo, self.lineEditAccesorios)
        QWidget.setTabOrder(self.lineEditAccesorios, self.btnGuardar)
        QWidget.setTabOrder(self.btnGuardar, self.btnCancelar)
    ...
    def retranslateUi(self, ReparacionesDialog):
        ...
        self.lineEditCliente.setPlaceholderText(QCoreApplication.translate("ReparacionesDialog", u"Nombre del cliente...", None))
        self.labelMarca.setText(QCoreApplication.translate("ReparacionesDialog", u"&Marca", None))
        self.lineEditMarca.setPlaceholderText(QCoreApplication.translate("ReparacionesDialog", u"Marca", None))
        self.labelModelo.setText(QCoreApplication.translate("ReparacionesDialog", u"&Modelo", None))
        self.lineEditModelo.setPlaceholderText(QCoreApplication.translate("ReparacionesDialog", u"Modelo", None))
        ...
        self.lineEditTecnico.setPlaceholderText(QCoreApplication.translate("ReparacionesDialog", u"T\u00e9cnico asignado", None))
        ...
        self.lineEditPassBloqueo.setPlaceholderText(QCoreApplication.translate("ReparacionesDialog", u"PIN/Patr\u00f3n", None))
        ...
        self.lineEditAccesorios.setPlaceholderText(QCoreApplication.translate("ReparacionesDialog", u"Accesorios entregados", None))
